...
2. Install pgAdmin 4 for database setup and then:
    ...
    - switch to connection tab and set following values:
      ...
      - Username: postgres
      - Password: 123456 
> **Note:** Password must be the same as the one you set when you altered **postgres** user. 
...
> **Note:** If postgis version error occurrs, potential solution could be doing apt install of postgresql-14-postgis-3 from  [here](https://www.ubuntuupdates.org/package/postgresql/focal-pgdg/main/base/postgresql-14-postgis-3) 
